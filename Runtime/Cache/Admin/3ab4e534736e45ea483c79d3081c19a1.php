<?php if (!defined('THINK_PATH')) exit();?><!-- layout::Admin:top::0 -->
    <div id="first_side">
    	<div id="cate_tree">
        	<h3>分类导航</h3>
        	<ul>
            	<li><a href="#"></a><span>心情点滴</span>
                	<ul>
                        <li><a href="#" class="open"></a><span>心情点滴</span></li>
                        <li><a href="#" class="open"></a><span>心情点滴</span></li>
                        <li><a href="#" class="leaf"></a><span>心情点滴</span></li>
                        <li><a href="#" class="leaf"></a><span>心情点滴</span></li>
                        <li><a href="#" class="leaf"></a><span>心情点滴</span></li>
                    </ul>
                </li>
                <li><a href="#"></a><span>心情点滴</span></li>
                <li><a href="#"></a><span>心情点滴</span></li>
                <li><a href="#"></a><span>心情点滴</span></li>
                <li><a href="#"></a><span>心情点滴</span></li>
            </ul>
    ...
    <div id="content">
    	<div id="info_list">
                    <div class="list_path">当前分类：心情点滴 > 每日一句 > 真情流露 <a href="__URL__/info_add" class="list_add">新增信息</a></div>
        	<table class="list">
            	<tr>
